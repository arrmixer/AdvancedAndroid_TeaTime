...
public class MenuActivityScreenTest {
    ...
    public static final String TEA_NAME_GREEN = "Green Tea";
    public static final String TEA_NAME_BLACK = "Black Tea";
    public static final String TEA_NAME_WHITE = "White Tea";
    public static final String TEA_NAME_OOLONG = "Oolong Tea";
    public static final String TEA_NAME_HONEY_LEMON = "Honey Lemon Tea";
    public static final String TEA_NAME_CHAMOMILE= "Chamomile Tea";
...
//        onView(withId(R.id.tea_name_text_view)).check(matches(withText(TEA_NAME)));
        ...
        onView(withId(R.id.tea_name_text_view)).check(matches(withText(TEA_NAME_BLACK)));
